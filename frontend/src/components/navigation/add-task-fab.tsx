 ...
 * از `lg` به بالا مخفی است چون `SidebarNav` دکمه‌ی «تسک جدید» خودش را دارد.
 */
export function AddTaskFab() {
  return (
    <Link
      ...
      className="fixed bottom-18 start-4 z-50 flex size-12 items-center justify-center rounded-full bg-brand text-icon-on-brand hover:opacity-90 lg:hidden"
    >
